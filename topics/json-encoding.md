...
* The `JSON Encoding` uses a container with "Type" and "[Object](../core-primitives/object.md)" keys. The
  "Type" key contains the [`Object Type`](../core-primitives/object-type.md) and the "Object" key contains the
